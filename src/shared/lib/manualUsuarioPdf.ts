...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Guardar pesos e históricos: el botón "Guardar pesos" guarda la pesada actual (los bigbags cargados) en un histórico; al guardar, esos bigbags pasan a la pesada y la pesada actual queda vacía para empezar otra. La tabla "Históricos de pesadas guardadas" lista cada pesada (fecha, N° de bigbags, Neto húmedo, Neto seco, estado) y es modificable: con "Editar" se abren sus bigbags para corregirlos (los totales se recalculan solos), se puede marcar Consumida/Disponible y eliminar. Todo se sincroniza en tiempo real; estos pesos guardados se tomarán luego en otro paso.',

...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Compra Directa - eliminar desde "Por recibir" (anular una compra cargada por error): el boton "Eliminar" de la tarjeta/fila aparece mientras la compra NO haya movido nada, es decir cuando Tesoreria todavia no la pago Y el almacenista todavia no le dio entrada. Cubre las que estan "En proceso" y tambien las montadas que esperan en "Por recibir". Al borrarla NO se toca la caja (no habia egreso) y desaparece de "Por pagar" en Tesoreria; se eliminan tambien sus facturas adjuntas. Pide confirmacion y no se puede deshacer. Las YA PAGADAS no se eliminan: primero se "Reabre" la compra (devuelve el dinero a la caja y revierte el inventario) y recien entonces se puede borrar. Las YA RECIBIDAS tampoco, porque movieron stock.',

...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Servicio Directo - Nota / motivo y edicion: el servicio directo se puede EDITAR (boton Editar del detalle) mientras esta En proceso: cambia servicios, proveedor, solicitante, la NOTA/MOTIVO y los datos de Pago a externo. La Nota / motivo es un texto libre que se carga al crear o editar y aparece en el DETALLE, en el PDF del servicio y en Tesoreria (junto al requerimiento del movimiento del pago).',

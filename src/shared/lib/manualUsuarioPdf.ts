...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Gasto del Centro de Acopio (Peramanal): en el modal de Registrar gasto hay un check "Es gasto del Centro de Acopio (Peramanal)". Al marcarlo, además del movimiento en Tesorería se crea automáticamente el movimiento espejo en la caja del Centro de Acopio con la misma descripción, categoría y subcategoría, en la columna Gastos o Nómina según la categoría, afectando la tasa $/kg. Si el gasto es en dólares (USD/USDT) se refleja por su monto; si es en Bs, se indica una tasa personalizada (Bs por $) y el sistema convierte el monto a $ para reflejarlo en Acopio. Si luego se elimina el gasto en Tesorería, su espejo en Acopio se elimina también.',

...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Quién aprueba/ejecuta las salidas y traslados: el administrador, los jefes/jefas y los analistas de área (Centro de Acopio, Tesorería), además de quien tenga permiso full en Salidas. El "Analista" base y el "Analista de Compras" NO pueden aprobar ni ejecutar salidas ni traslados (no ven el botón Aprobar); igual pueden registrar solicitudes. El obrero solo registra la solicitud (queda Por aprobar).',

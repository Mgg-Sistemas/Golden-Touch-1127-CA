...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      'Salida de material: despacha materiales del inventario. Permite varios materiales en una misma solicitud (como una OC en OP): se arma un carrito con "＋ Agregar material", cada renglón con su producto y cantidad, y al pie se ve el Total; todos salen del mismo Almacén origen y se aprueban/ejecutan de una sola vez. Muestra la Sede origen (Peramanal) y el Almacén origen (sub-almacén). Ya no pide "a quién va dirigido": solo descuenta el inventario. El precio unitario está anclado al VALOR del material: es el costo (PMP) de ese almacén y no se edita (una caja de 10 lápices que costó $100 vale $10 c/u; al sacar 1, los 9 restantes valen $90). Lleva un selector de Unidad solicitante igual al de la OP, con el mismo catálogo (sincronizado en vivo) y opción de añadir una unidad nueva.',

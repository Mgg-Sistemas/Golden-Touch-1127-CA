...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'HRS restantes y alerta: la tabla muestra las HRS que faltan para el próximo mantenimiento (horómetro vigente + frecuencia). Si faltan ≤ 250 HRS, el equipo se marca con ⚠️ y aparece un aviso arriba. El horómetro vigente se trae de Combustible si el equipo está vinculado.',

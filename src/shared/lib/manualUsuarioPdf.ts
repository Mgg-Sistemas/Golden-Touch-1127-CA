...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Compra Directa - eliminar en cualquier estado (con reverso automatico): el boton "Eliminar" (tarjeta, fila y detalle) borra una compra directa en CUALQUIER estado, revirtiendo automaticamente lo que haya movido. En proceso o Por pagar sin recibir: se borra directo (no habia egreso ni stock; desaparece de "Por pagar"/"Por recibir"). Por recibir ya recibida (stock ingresado sin pagar): revierte la entrada al inventario y borra. Finalizada (pagada): hace lo mismo que Reabrir (devuelve el dinero a la caja, exacto incluso en Multimoneda, y revierte la entrada al inventario) y luego borra, todo en UN paso. Cuando ya movio caja o inventario, pide escribir "ELIMINAR" para confirmar. Siempre se eliminan sus facturas adjuntas y no se puede deshacer (si el stock ya se consumio, el inventario queda en 0, no negativo).',

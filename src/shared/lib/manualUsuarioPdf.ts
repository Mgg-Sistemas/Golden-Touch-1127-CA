...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Compra directa: las compras sin proceso de aprobación pueden asociar un proveedor con buscador; si no existe, se agrega en el momento y queda guardado en el directorio de Proveedores. Al cargar la factura y elegir la caja se muestra su billetera (saldo disponible, por moneda si es Multimoneda) y el gasto se descuenta del saldo de esa caja (el mismo que se ve en Cajas/Tesorería). Una compra directa En proceso se puede eliminar con el botón Eliminar (las Finalizadas no, porque ya movieron dinero e inventario).',

...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'OC - IVA con % editable al indicar el metodo de pago: cuando el tipo de soporte es "Factura" se elige "Sin IVA" o "Con IVA". El porcentaje viene precargado en 16% (alicuota general) pero es un campo EDITABLE: si la factura del proveedor trae otra alicuota se escribe ahi y el sistema recalcula al instante el monto del IVA y el total con IVA. Si se coloca un porcentaje distinto de 16 aparece un aviso para verificarlo contra la factura. El % aplicado queda guardado y se muestra en el detalle de la OC, en el PDF de la orden de compra (base imponible, IVA y total) y en el PDF de trazabilidad.',

...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Tanques — Consumo semanal de combustible a la caja de Peramanal (automático): cada domingo el sistema suma el consumo de GT de la semana (movimientos de tanque tipo uso, valuados a su costo por tasa PMP) y lo carga como el gasto "CONSUMO COMBUSTIBLE GT" en la caja de Peramanal abierta (alimenta la tasa $/kg). El botón "Consumo semanal → caja" es el respaldo manual para re-generar una semana puntual (lunes→domingo) si el automático no corrió; es idempotente (re-generar la misma semana reemplaza el gasto, no lo duplica). La compra/recepción de combustible al tanque es aparte.',

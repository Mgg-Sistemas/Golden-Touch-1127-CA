...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Totales - Humedad (calculada): en el documento de Totales, las filas rojas Humedad Provisional (Laboratorio) y Humedad Adicional (Final) ya no se teclean: se calculan solas desde las mermas de peso H2O del lote. Humedad Provisional (Laboratorio) = Merma peso H2O de Humedad Provisional; Humedad Adicional (Final) = Merma peso H2O de Humedad Provisional - Merma peso H2O de Humedad Final. Fe estéril sigue siendo editable. Estos valores suman al Total SnO2 del costo final (Pesos Kg + Humedad Prov + Humedad Final + Fe estéril) y se actualizan en vivo.',

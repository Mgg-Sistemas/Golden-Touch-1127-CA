...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      'Salida de material: despacha un producto del inventario. Muestra la Sede origen (Peramanal) y el Almacén origen (sub-almacén). Ya no pide "a quién va dirigido": solo descuenta el inventario. El precio unitario está anclado al VALOR del material: es el costo (PMP) de ese almacén y no se edita (una caja de 10 lápices que costó $100 vale $10 c/u; al sacar 1, los 9 restantes valen $90). Lleva un selector de Unidad solicitante igual al de la OP, con el mismo catálogo (sincronizado en vivo) y opción de añadir una unidad nueva.',
      'Traslado de material: mueve productos entre almacenes dentro de la Sede Peramanal (origen → destino), conservando el costo (PMP) del origen (precio anclado, no editable). También lleva el selector de Unidad solicitante del catálogo de OP.',

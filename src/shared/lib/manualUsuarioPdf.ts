...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Compra directa - categoría nueva al vuelo: al dar de alta un material nuevo, si su categoría no existe se puede crear en el momento con el campo "Nueva categoría..." + Añadir, sin salir de la compra. Queda guardada en el catálogo de inventario y seleccionada en ese renglón.',

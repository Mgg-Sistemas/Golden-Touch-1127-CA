...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      '3 tarjetas de estado (arriba): "Vehículos / Maquinaria ACTIVA" (operativos), "En MANTENIMIENTO" (equipos con al menos una solicitud de servicio registrada — al tocarla lleva al submódulo Servicio de Mantenimiento para darles seguimiento) y "En ESTADO CRÍTICO" (mantenimiento vencido o fuera de servicio). Tocar Activa o Crítico filtra la tabla a esos equipos.',

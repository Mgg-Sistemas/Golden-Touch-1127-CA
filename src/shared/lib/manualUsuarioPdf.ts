...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    puntos: [
      ...
      'Tanques — Vista de inicio: una tarjeta-resumen destacada muestra el combustible total disponible (ltrs), la cantidad de tanques, el valor total en $ y la tasa promedio (ponderada por litros, correcta aunque cada tanque tenga distinta tasa). Debajo están las tarjetas de cada tanque (litros disponibles, capacidad, tasa y resumen de entradas/uso/traslados).',

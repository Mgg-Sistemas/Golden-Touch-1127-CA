...
const CATEGORIAS_DOCUMENTO = new Set(['pago_oc', 'reembolso_oc', 'compra_directa', 'servicio_directo', 'reembolso_compra_directa', 'reembolso_servicio_directo', 'reverso', 'conciliacion']);

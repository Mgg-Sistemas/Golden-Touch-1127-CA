/* ============================================================
   Golden Touch · Inventario · Histórico de recepciones
...
export function RecepcionesHistorialModal({ productos, onClose }: {
  ...
  // Si alguien recibe una orden con esta pantalla abierta, la recepción aparece sola.
  useRealtime(['movimientos'], () => { void cargar(); });
